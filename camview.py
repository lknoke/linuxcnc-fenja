...
# Added by Bogie
	'radius_difference' : (gobject.TYPE_INT, 'Radius Difference', 'The step size the radius buttons make',
                    1, 20, 10, gobject.PARAM_READWRITE | gobject.PARAM_CONSTRUCT),
# Bogie
        ...
        try:
            ...
            if name in self.__gproperties.keys():
                ...
                if name == "number_of_circles":
                    self.circles = value
# Added by Bogie
		if name == "radius_difference":
                    self.radius_difference = value
# Bogie
                if name == "autosize":
                    self.autosize = value
